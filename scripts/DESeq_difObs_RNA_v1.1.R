...
file <- 'RNA_unnormed_read_counts_by_gene.tsv'
...
head(result)
write.table(result, "DESeq_Obs_RNA_DGY1657_DGY1726.txt", sep = '\t')
...
result <- result[complete.cases(result),]  #remove any rows with NA
head(result)
write.table(result, "DESeq_Obs_RNA_DGY1657_DGY1735.txt", sep = '\t')
...
result <- result[complete.cases(result),]  #remove any rows with NA
head(result)
write.table(result, "DESeq_Obs_RNA_DGY1657_DGY1741.txt", sep = '\t')
...
result <- result[complete.cases(result),]  #remove any rows with NA
head(result)
write.table(result, "DESeq_Obs_RNA_DGY1657_DGY1743.txt", sep = '\t')
